...
if /i "%1"=="x32"	call setenv.bat x32&set type=Configuration=Debug;Platform=Win32&goto build
if /i "%1"=="x64"	call setenv.bat x64&set type=Configuration=Debug;Platform=x64&goto build
...
echo.
echo Examples:
echo   build.bat x32               : builds 32-bit debug build
echo   build.bat x64               : builds 64-bit debug build
