...
void MainWindow::displayAboutWidget()
{
    ...
    QString logo_icon = ":/icons/images/bug64.png";
#else
    QString title = tr("About x32dbg");
    QString logo_icon = ":/icons/images/bug32.png";
#endif //_WIN64
    title += QString().sprintf(" v%d", BridgeGetDbgVersion());
    QString compilation_date = ToDateString(GetCompileDate()) + ", " __TIME__;

    AboutDialog aboutBox(title, logo_icon, compilation_date, this);
    aboutBox.exec();
}
