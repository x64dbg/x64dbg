...
protected:
    ...
    void drawBullets(QPainter* painter, int line, bool ispb, bool isbpdisabled, bool isbookmark, bool isbpconditional);
...
private:
    ...
    QColor mBulletConditionalBreakpointColor;
    QColor mBulletBookmarkColor;
    QColor mBulletColor;
    QColor mBulletDisabledBreakpointColor;
    QColor mBulletDisabledConditionalBreakpointColor;
